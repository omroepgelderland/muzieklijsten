...
export function post<F extends keyof AjaxMap>(
  ...
  return new Promise((resolve, reject) => {
      ...
      xhr.onload = (post_verwerk_respons<AjaxMap[F]['response']>).bind(undefined, xhr, resolve, reject);
      xhr.onerror = (post_verwerk_respons<AjaxMap[F]['response']>).bind(undefined, xhr, resolve, reject);
